...
const pt = {
  ...
  no_tracks: "Nenhuma track ainda",
  create_first_track: "Criar primeira track",
  move_to_column: "Mover para coluna",
  move_to_track: "Mover para track",
  ...
  manage_tags_desc: "Tags categorizam seus cards. Excluir uma tag remove ela de todos os cards.",
  ...
  // ── TracksModal ──
  manage_tracks: "Gerenciar tracks",
  manage_tracks_desc: "Tracks são as swimlanes do board. Excluir uma track move todos os cards dela para a primeira track restante.",
  no_tracks_yet: "Nenhuma track ainda.",
  new_track: "Nova track",
  track_name_placeholder: "Nome da track",
  ...
  cards_by_track: "Cards por track",
