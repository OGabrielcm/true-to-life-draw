...
const pt = {
  ...
  empty_board_title: "Board vazio",
  empty_board_desc: "Crie seu primeiro card para começar a organizar suas tarefas.",
...
const en = {
  ...
  empty_board_title: "Empty board",
  empty_board_desc: "Create your first card to start organizing your tasks.",
